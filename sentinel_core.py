...
try:
    ...
    print(f"✅ MediaPipe imported in sentinel_core")
except ImportError as e:
    print(f"⚠️ MediaPipe import error in sentinel_core: {e}")
    # Create dummy class if mediapipe not available
    class DummyMediaPipe:
        class solutions:
...
class SentinelVisionPro:
    ...
    def __init__(self):
        ...
        print("🛡️ Sentinel Vision Pro initialized")

    def _init_mediapipe(self):
        """Initialize MediaPipe components with error handling"""
        try:
            # Check if mediapipe is properly imported
            ...
            print(f"⚠️ Unexpected MediaPipe error: {e}")
            self.mp_selfie = None
            self.mp_face = None
            self.mp_hands = None
            self.mp_drawing = None
    ...
    def _classify_gesture(self, hand_landmarks):
        ...
        try:
            ...
            print(f"⚠️ Gesture classification error: {e}")
            return 'unknown'
    ...
    def handle_gesture(self, gesture, frame):
        ...
        if action == 'activate_shield':
            ...
            if self.background_plate is None and frame is not None:
    ...
    def _apply_invisibility(self, frame):
        ...
        try:
            ...
            print(f"⚠️ Invisibility error: {e}")
    ...
    def _apply_predator_mode(self, frame):
        ...
        try:
            ...
            print(f"⚠️ Predator mode error: {e}")
